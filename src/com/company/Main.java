...
public class Main {
    ...
    public static void main(String args[])
    {
        ...
        {
            System.out.println("Enter the desired 'N' for  set Associative mapping. N must be a multiple of 2 and must be less than the number of cache blocks "+number_of_blocks);
            n = in.nextInt();
